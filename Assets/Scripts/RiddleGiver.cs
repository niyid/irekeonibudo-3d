...
// Attach to any spirit or trial-giver that should pose a riddle when the
// player gets close and presses an interact key. Wisdom is the resource
// both Fagunwa stories' structures are built around: you bring it back
// to safety, not just loot.
//
// Story-agnostic by design — used by ogbojuode-3d's Ostrich-King/ghommids
// and irekeonibudo-3d's Arogidigba/mother-spirit guides alike. On a failed
// riddle it calls OnRiddleFailed() via SendMessage rather than referencing
// a specific boss class, so it doesn't need to know which sibling project
// it's running in.
